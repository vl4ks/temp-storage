...
**Связь:** Композиция с `ServiceManagementService`, ` AuthService` - для управления услугами(создание, редактирование правил), для аутентификации и проверки прав доступа администратора.
